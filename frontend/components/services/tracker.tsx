                        ...
                        <DialogDescription>
                            {currentStop ? (
                                <>
                                    ...
                                    <div>
                                        <p className="text-blue-400">Arriving: {convert24hTo12h(addSecondsToTime(currentStop.arrival_time, tripUpdate.delay))}</p>
                                        {currentStop.platform !== "" && currentStop.platform !== "no platform" ? (
                                            <p className="text-blue-400">Platform: {currentStop.platform}</p>
                                        ) : null}
                                    </div>
